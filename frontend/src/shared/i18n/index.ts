  ...
  "zh-CN": {
    translation: {
      ...
      accounts: {
        ...
        chatProbeDescription: "会对全部启用中的 Grok Build 账号发起一次上游 chat 探测（走出口代理）。命中 chat 端点 403/permission-denied 的账号会直接删除，无法撤销。",
        chatProbeSelectedDescription: "会对所选 {{count}} 个 Grok Build 账号发起上游 chat 探测（走出口代理）。命中 chat 端点 403/permission-denied 的账号会直接删除，无法撤销。",
        chatProbeProgress: "检测进度 {{completed}} / {{total}}",
        chatProbeStart: "开始检测并删除",
        chatProbeCompleted: "检测完成：检查 {{checked}}，删除 {{deleted}}，失败 {{failed}}，跳过 {{skipped}}",
      },
      quotaProducts: {
        thirdParty: "第三方",
        api: "API",
