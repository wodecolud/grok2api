  ...
  "zh-CN": {
    translation: {
      ...
      accounts: {
        ...
        cleanupStart: "开始清理",
        chatProbeAction: "检测 chat 403",
        chatProbeTitle: "批量检测 Grok Build chat 403？",
        chatProbeDescription: "会对全部启用中的 Grok Build 账号并发发起上游 chat 探测（复用额度同步线程池，走出口代理）。命中 chat 端点 403/permission-denied 的账号会直接删除，无法撤销。",
        chatProbeSelectedDescription: "会对所选 {{count}} 个 Grok Build 账号并发发起上游 chat 探测（复用额度同步线程池，走出口代理）。命中 chat 端点 403/permission-denied 的账号会直接删除，无法撤销。",
        chatProbeProgress: "检测进度 {{completed}} / {{total}}",
        chatProbeStart: "开始检测并删除",
        chatProbeCompleted: "检测完成：检查 {{checked}}，删除 {{deleted}}，失败 {{failed}}，跳过 {{skipped}}，并发 {{workers}}",
      },
      quotaProducts: {
        thirdParty: "第三方",
        api: "API",
      ...
      apiErrors: {
        ...
        buildChatProbeFailed: "检测 Grok Build chat 访问失败",
  ...
  en: {
    translation: {
      ...
      apiErrors: {
        ...
        buildChatProbeFailed: "Failed to probe Grok Build chat access",
